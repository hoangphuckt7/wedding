...
const wedding = {
  groom: {
    ...
    location: "30 Bạch Đằng, P.Kon Tum, Tỉnh Quãng Ngãi (TP. Kon Tum cũ)",
    timeline1: "10:00",
    timeline2: "11:00",
    timeline3: "11:30",
  },
...
function playMusic() {
  ...
  bgMusic.play()
    .then(() => {
      musicPlaying = true;
      musicBtn.innerHTML = `<div class="playing" style="index:999">
...
function pauseMusic() {
  ...
  musicBtn.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" style="color: #ffffff; margin:10px; index:999">
